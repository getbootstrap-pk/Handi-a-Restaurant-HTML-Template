...
// map center
var center = new google.maps.LatLng(37.799641, -122.444605);

// marker position
var factory = new google.maps.LatLng(37.799641, -122.444605);
...
function initialize() {
  ...
  var map = new google.maps.Map(document.getElementById("contact_map_2"),mapOptions);

  // InfoWindow content
  var content = '<div id="iw-container">' +
                    '<div class="iw-title">Handi - Best Restaurant </div>' +
                    '<div class="iw-content">' +
                      '<p>831/17 Second Street, Manchester, UK'+
